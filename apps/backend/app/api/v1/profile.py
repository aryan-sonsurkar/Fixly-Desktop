...
async def get_my_profile(
    ...
    service = ProfileService(access_token=current_user.access_token)
...
async def complete_onboarding(
    ...
    profile_service = ProfileService(access_token=current_user.access_token)
    subject_service = SubjectService(access_token=current_user.access_token)
